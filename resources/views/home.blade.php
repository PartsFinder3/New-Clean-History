...
<section id="steps-of-work" class="relative bg-background-secondary py-20 px-4 md:px-8 border-y border-card-border">
...
<section class="mx-auto max-w-6xl px-4 py-20 md:px-8">
    <div class="flex items-end justify-between mb-8">
        <div>
            ...
            <p class="text-muted mt-2">Verified used cars directly from Dubai, Abu Dhabi & Sharjah garages</p>
        </div>
        <a href="{{ route('cars.index') }}" class="text-sm font-medium text-accent hover:text-accent-hover flex items-center gap-1">
            View All Cars <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
        </a>
    </div>
    ...
    @else
        <div class="rounded-2xl border border-dashed border-card-border bg-background-secondary px-6 py-20 text-center">
            <p class="text-muted font-medium">Browse our garage car listings - Coming soon with verified UAE dealers</p>
            <a href="{{ route('contact') }}" class="btn-primary mt-4 inline-block">List Your Car</a>
        </div>
    @endif
</section>

<section class="relative overflow-hidden bg-gradient-to-br from-blue-600 to-blue-800 border-t border-card-border px-4 py-20 md:px-8">
    <div class="absolute inset-0 bg-[url('/grid.svg')] opacity-10"></div>
    <div class="relative mx-auto max-w-4xl text-center">
        <h2 class="font-display text-3xl font-bold text-white md:text-4xl">
            Ready to <span class="text-blue-200">Clean</span> Your Car History?
        </h2>
        <p class="mt-6 text-blue-100 text-lg">
            Get a free VIN audit via WhatsApp. Serving Dubai, Abu Dhabi, Sharjah and all UAE emirates.
        </p>
        <div class="mt-10 flex flex-wrap justify-center gap-4">
            <a href="https://wa.me/923004531248?text=Hi, I want a free VIN audit for car history removal in UAE" target="_blank" class="inline-flex items-center gap-2 rounded-xl bg-white px-8 py-4 text-sm font-bold text-blue-700 transition hover:bg-blue-50 active:scale-95 shadow-lg">
            ...
            <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 rounded-xl border border-white/30 bg-white/10 px-8 py-4 text-sm font-bold text-white transition hover:bg-white/20 active:scale-95">
                Contact Form
            </a>
        </div>
    </div>
