...
<div class="max-w-5xl mx-auto py-8 px-4 md:py-12 md:px-8">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl md:text-4xl font-bold text-white font-outfit tracking-tight">Create New Blog</h1>
            <p class="text-zinc-400 mt-1">Add a new blog post with SEO optimization.</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="2"
                        class="w-full px-4 py-3 bg-zinc-950 border border-zinc-800 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                        placeholder="Short description for blog cards (max 500 characters)">{{ old('excerpt') }}</textarea>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex justify-between mt-1">
                        ...
                        <p class="text-zinc-500 text-xs"><span id="meta_title_count">0</span>/70</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="meta_description" id="meta_description" rows="3" maxlength="160"
                        class="w-full px-4 py-3 bg-zinc-950 border border-zinc-800 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all"
                        placeholder="SEO description for search results">{{ old('meta_description') }}</textarea>
                    <div class="flex justify-between mt-1">
                        <p class="text-zinc-500 text-xs">Description shown below the title in search results.</p>
                        <p class="text-zinc-500 text-xs"><span id="meta_description_count">0</span>/160</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="meta_author" id="meta_author" value="{{ old('meta_author') }}"
                        class="w-full px-4 py-3 bg-zinc-950 border border-zinc-800 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all"
