    ...
    <div class="mx-auto max-w-6xl px-4 py-12 md:px-8">
        <div class="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <div class="mt-4 flex gap-4">
                    <a href="https://wa.me/923004531248" class="text-zinc-400 hover:text-cyan-400 transition">
        ...
        <div class="mt-12 flex flex-wrap items-center justify-between gap-8 border-y border-zinc-800/80 py-8">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="//www.dmca.com/Protection/Status.aspx?ID=carhistoryclean" title="DMCA.com Protection Status" class="dmca-badge h-8 opacity-60 hover:opacity-100 transition-opacity">
